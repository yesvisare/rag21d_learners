...
Run with: pytest tests/test_prompt_ops.py
or: python -m pytest tests/test_prompt_ops.py
"""
...
from src.m2_2_prompt_optimization import (
    RAGPromptLibrary,
    TokenEstimator,
    ModelRouter,
    ModelTier,
...
def test_context_formatting():
    ...
    # Load example data
    data_path = os.path.join(os.path.dirname(__file__), "..", "data", "example", "example_data.json")
